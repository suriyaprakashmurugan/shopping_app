      ...
      <div className="container-fluid footer">
        ...
        <div className="container">
            <ul className="d-flex justify-content-around footer_soc">
                <li className=""><i class="fa-solid fa-user"> </i> Become Seller</li>
                <li className=""><i class="fa-solid fa-handshake-angle"> </i>Help Center</li>
                <li className=""><i class="fa-brands fa-facebook"></i>    <i class="fa-brands fa-twitter"></i></li>
                <li className=""><i class="fa-solid fa-gift"> </i>Gift Card</li>
                <li className=""><i class="fa-solid fa-shop"> </i>Joy.com</li>
            </ul>
        </div>
      </div>
    </>
